# 注意力评分函数
 ...
 图（sec_nadaraya-watson）使用了高斯核来对查询和键之间的关系建模。
 公式（eq_nadaraya-watson-gaussian）中的
...
例如，为了在 图（sec_machine_translation）中高效处理小批量数据集，
某些文本序列被填充了没有意义的特殊词元。
...
![](../img/generated/25c193193d-output-1.svg)
...
![](../img/generated/25c193193d-output-2.svg)
