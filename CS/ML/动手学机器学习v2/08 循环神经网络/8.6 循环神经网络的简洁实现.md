...
事实上，我们还没有讨论多层循环神经网络的意义（这将在 图（sec_deep_rnn）中介绍）。
...
![](../img/generated/257138ba76-output-1.svg)
...
1. 尝试使用循环神经网络实现 图（sec_sequence）的自回归模型。
