...
在 图（sec_sgd）一节中，我们详述了如何执行随机梯度下降，即在只有嘈杂的梯度可用的情况下执行优化时会发生什么。
...
例如，请参阅[文章](https://distill.pub/2017/momentum/）（作者是 文献（Goh.2017）)，观看深入分析和互动动画。
动量是由 文献（Polyak.1964）提出的。
 文献（Nesterov.2018）在凸优化的背景下进行了详细的理论讨论。
长期以来，深度学习的动量一直被认为是有益的。
有关实例的详细信息，请参阅 文献（Sutskever.Martens.Dahl.ea.2013）的讨论。

### 条件不佳的问题

为了更好地了解动量法的几何属性，我们复习一下梯度下降，尽管它的目标函数明显不那么令人愉快。
回想我们在 图（sec_gd）中使用了$f(\mathbf{x}) = x_1^2 + 2 x_2^2$，即中度扭曲的椭球目标。
...
![](../img/generated/e3fdb08c8c-output-1.svg)
...
![](../img/generated/e3fdb08c8c-output-2.svg)
...
![](../img/generated/e3fdb08c8c-output-3.svg)
...
![](../img/generated/e3fdb08c8c-output-4.svg)
...
![](../img/generated/e3fdb08c8c-output-5.svg)
...
![](../img/generated/e3fdb08c8c-output-6.svg)
...
![](../img/generated/e3fdb08c8c-output-7.svg)
...
![](../img/generated/e3fdb08c8c-output-8.svg)
...
![](../img/generated/e3fdb08c8c-output-9.svg)
...
![](../img/generated/e3fdb08c8c-output-10.svg)
...
请参阅[文章](https://distill.pub/2017/momentum/) 文献（Goh.2017）了解精彩动画。
请参阅 文献（Flammarion.Bach.2015）了解详细分析。
