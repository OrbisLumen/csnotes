...
![](../img/generated/53a89d75dd-output-1.svg)
...
![](../img/generated/53a89d75dd-output-2.svg)

相反，如果我们使用过高的学习率，$\left|\eta f'(x)\right|$对于一阶泰勒展开式可能太大。
也就是说， 公式（gd-taylor）中的$\mathcal{O}(\eta^2 f'^2(x))$可能变得显著了。
...
![](../img/generated/53a89d75dd-output-3.svg)
...
![](../img/generated/53a89d75dd-output-4.svg)
...
![](../img/generated/53a89d75dd-output-5.svg)

## 自适应方法

正如我们在 图（subsec_gd-learningrate）中所看到的，选择“恰到好处”的学习率$\eta$是很棘手的。
...
毕竟，$f$的最小值满足$\nabla f = 0$。
遵循 图（sec_calculus）中的微积分规则，
通过取$\boldsymbol{\epsilon}$对 公式（gd-hot-taylor）的导数，
再忽略不重要的高阶项，我们便得到
...
![](../img/generated/53a89d75dd-output-6.svg)
...
![](../img/generated/53a89d75dd-output-7.svg)
...
![](../img/generated/53a89d75dd-output-8.svg)
...
有关分析和证明，此算法收敛迅速（请参见 文献（Boyd.Vandenberghe.2004））。
然而，对深度学习而言，这不太可行。
