...
让我们通过实例化 图（sec_rnn_scratch）中
引入的`RNNModelScratch`类来训练一个长短期记忆网络，
就如我们在 图（sec_gru）中所做的一样。
...
![](../img/generated/950aa92b0b-output-1.svg)
...
![](../img/generated/950aa92b0b-output-2.svg)
